...
public class ViewModelBase : RxDisposableObject, INavigatedAware, IDestructible, IReactiveObject
{
    ...
    /// <inheritdoc />
    void IReactiveObject.RaisePropertyChanging(System.ComponentModel.PropertyChangingEventArgs args) => RaisePropertyChanging(args.PropertyName ?? throw new InvalidOperationException());
